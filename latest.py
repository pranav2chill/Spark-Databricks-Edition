...
def print_performance_metrics(predictions):
  ...
  # F1
  print("F1 for label 0 = {}".format(multi_metrics.fMeasure(0.0)))
  print("F1 for label 1 = {}".format(multi_metrics.fMeasure(1.0)))
  # Precision
  print("Precision for label 0 = {}".format(multi_metrics.precision(0.0)))
  print("Precision for label 1 = {}".format(multi_metrics.precision(1.0)))
  # Recall
  print("Recall for label 0 = {}".format(multi_metrics.recall(0.0)))
  print("Recall for label 1 = {}".format(multi_metrics.recall(1.0)))
  # FPR
